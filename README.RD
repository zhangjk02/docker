...
1.
docker run -dit \
   -v 目录/jd/config:/jd/config \
   -v 目录/jd/log:/jd/log \
   -v 目录/jd/scripts:/jd/scripts \
   -v 目录/jd/own:/jd/own \
   -p 5678:5678 \
...
1.
docker run -dit \
   -v 目录/qinglong/config:/ql/config \
   -v 目录/qinglong/log:/ql/log \
   -v 目录/qinglong/scripts:/ql/scripts \
   -v 目录/qinglong/db:/ql/db \
   -p 5700:5700 \
   -e ENABLE_HANGUP=true \
   -e ENABLE_WEB_PANEL=true \
   --name qinglong \
